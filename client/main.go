...
// func (c *Client) SendTransaction(txType string, amount float64) (Response, error) {
// 	// Prepare the request
...
// 	// Perform a deposit
// 	resp, err := client.SendTransaction("deposit", 500.0)
// 	if err != nil {
...
// 	resp, err = client.SendTransaction("withdraw", 200.0)
// 	if err != nil {
// 		fmt.Println("Error:", err)
// 	} else {
...
//		// Try to replay the last request (should fail)
//		resp, err = client.SendTransaction("withdraw", 200.0)
//		if err != nil {
